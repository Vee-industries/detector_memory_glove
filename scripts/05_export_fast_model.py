...
def generate_campaign(
    ...
    noise_scale=0.50,
    signal_inc=0.02,          # locked weak generator
    front_frac=0.15,
    p_front=0.01,
    p_quiet=0.002,
    p_back=0.08,
...
def main():
    ...
    print("Generating training campaigns...")
    ...
    print("Training stateful logistic model...")
    model = make_pipeline(
        StandardScaler(),
        LogisticRegression(max_iter=2000, C=1.0),
    )
    model.fit(X_train_stateful, y_train)

    print("Saving model to ema_model.joblib...")
    joblib.dump(model, "models/ema_model.joblib")
    print("Done.")
